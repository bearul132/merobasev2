...
// Cloudinary upload helper — same env names you used in AddSample
async function uploadToCloudinary(file) {
  ...
  if (!uploadUrl || !uploadPreset) {
    throw new Error("Cloudinary is not configured. Check your .env (VITE_CLOUDINARY_*).");
  }
